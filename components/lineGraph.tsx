...
const LineChart = () => {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <select id="category-select" style={{ color: 'white', position: 'absolute', background: 'grey', top: '0', right: '0vw', borderRadius: '1rem', textAlign: 'center' }} value={selectedCategory} onChange={handleCategoryChange}>
        {categoryOptions}
      </select>
      ...
      <Typography style={{ color: 'white', marginTop: '1rem', fontWeight: 500, textAlign: 'center' }}>Climate Risk Rating Line Graph Over Time</Typography>
    </div>
  );
};
